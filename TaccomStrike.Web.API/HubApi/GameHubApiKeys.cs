...
namespace TaccomStrike.Web.API.HubApi
{
	public static class GameHubApiKeys
	{
		...
		public static string GameFinish = "GameFinish";
		...
		public static string GameLobbyJoin = "GameLobbyJoin";
		public static string GameLobbySendMessage = "GameLobbySendMessage";
	}
}
