...
namespace TaccomStrike.Console.ConfigurationManager
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var dbOptionsBuilder = new DbContextOptionsBuilder<TaccomStrikeContext>();
            dbOptionsBuilder.UseSqlServer(connString);
            var dbContext = new TaccomStrikeContext(dbOptionsBuilder.Options);
